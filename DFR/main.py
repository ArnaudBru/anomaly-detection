...
def config():
    ...
    # default values
    data_name = "bottle"
    train_data_path = "/content/" + data_name + "/train/good"
    test_data_path = "/content/" + data_name + "/test"

    parser.add_argument('--data_name', type=str, default=data_name, help="data name, or all")
    ...
    parser.add_argument('--epochs', type=int, default=50, help="epochs for training")    # default 700, for wine 150
...
if __name__ == "__main__":
    ...
    # train or evaluation
    if cfg.data_name == "all":
        for data_name in data_names:
            cfg.data_name = data_name
            cfg.train_data_path = "/content/" + data_name + "/train/good"
            cfg.test_data_path = "/content/" + data_name + "/test"
